...
\begin{itemize}
	\item deploying \texttt{python_function} model to Microsoft Azure ML
	\item deploying \texttt{python_function} model to Amazon SageMaker
	\item exporting \texttt{python_function} as an ApacheSpark UDF
